...
public class MediaList {
	...
	public void setPaperWordCnt(String paperWordCnt) {
		this.paperWordCnt = paperWordCnt;
	}
	...
	public String getSupportSevenDays() {
		return supportSevenDays;
	}
	public void setSupportSevenDays(String supportSevenDays) {
		this.supportSevenDays = supportSevenDays;
	}
	...
	public Float getAvgStarLevel() {
		return avgStarLevel;
	}
	public void setAvgStarLevel(Float avgStarLevel) {
