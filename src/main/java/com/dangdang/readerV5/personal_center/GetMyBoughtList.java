...
public class GetMyBoughtList extends FixtureBase{
    ...
    protected void dataVerify() throws Exception {
        if(reponseV2Base.getStatus().getCode()==0){
            ...
            List<MediaBought> boughts= MediaBoughtDb.getBoughtList(login.getCustId(), paramMap.get("fromPaltform")==null?PlatForm.YC:PlatForm.valueOf(paramMap.get("fromPaltform").toUpperCase()),
