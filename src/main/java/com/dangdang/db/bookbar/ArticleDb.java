...
public class ArticleDb {
	 ...
	 *                 46:贴子分享贴;47:书单分享贴;48:专题分享贴;49:攻略分享贴;50:reader图片分享贴)
	 */
	public static List<Article> getArticlebyIds(List<String> digestId) throws Exception{
		String sql = "select * from article where is_show=1 and is_del=0 and media_digest_id in("+ StringUtils.join(digestId,",")+")";
		List<Article> article = DbUtil.selectList(Config.BOOKBARDBConfig, sql, Article.class);
		return article;
	}
